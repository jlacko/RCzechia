...
#'
#' The data is current to July 2025. Downloaded size of high resolution shapefile is <1 MB; low resolution object is internal.
#'
...
kraje <- function(resolution = "high") {
  ...
  if (resolution == "low") {
    ...
    result <- .downloader("Kraje-R-2025-07.rds")
    result
  }
}
