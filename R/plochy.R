...
#'
#' A Large SpatialPolygonsDataFrame containing water bodies (vodní plochy) of the Czech Republic.
#'
#' @format 480 water bodies of the Czech Repubic, as Large SpatialPolygonsDataFrame.
#' \describe{
