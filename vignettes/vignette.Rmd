...
Population of the Czech Republic from the 2011 census, per district (okres). The results can be easily accessed from the comfort of your R session using the excellent package [{czso}](https://petrbouchal.xyz/czso/index.html) by Petr Bouchal.
...
##   Size: 44.5 kB
## <ON DISK>  /tmp/RtmpwrRYlw/file371f2449ce7e.xls
