...
```{r geocode, echo = T, eval = T, message = F, out.width = '100%'}
library(RCzechia)
library(dplyr)
library(tmap)
library(sf)
...
```{r unempl, echo = T, eval = T, message = F, out.width = '100%'}
library(dplyr)
library(RCzechia)
library(tmap)
library(sf)
...
```{r distance, echo = T, eval = T, message = F, out.width = '100%'}
library(dplyr)
library(RCzechia)
library(sf)
library(units)
...
```{r interactive, echo = T, eval = T, message = F, out.width = '100%'}
library(dplyr)
library(RCzechia)
library(tmap)
library(sf)
